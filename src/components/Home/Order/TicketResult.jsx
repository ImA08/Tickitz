        ...
        >
          <div className="bg-black/70 flex items-center justify-center w-full h-full">
            <div className="px-25 text flex flex-col items-center md:block gap-5.5">
              <img src={logoTickitz} alt="tickitz" className="w-31.75 h-12 md:w-66.75 md:h-26" />
              ...
              <p className="text-[18px] font-bold text-white flex flex-col items-center gap-5.5 hover:scale-[1.05] cursor-pointer md:flex-row">
                ...
                <img src={logoArrow} height={24} width={24} alt="order ticket" className="rotate-90 md:rotate-0" />
              </p>
            </div>
          </div>
        </section>

        <section className="ticket-display flex flex-col items-center md:flex-4">
          ...
          <div className="btn w-89.5 flex flex-col items-center gap-5 my-5 ">
            ...
            <Link to="/" className="flex items-center justify-center w-5/6 h-16 text-(--primary-color) border border-(--primary-color) hover:bg-(--primary-color) hover:text-white rounded-[5px] hover:scale-[1.05]">
              Done
            </Link>
          </div>
        </section>
