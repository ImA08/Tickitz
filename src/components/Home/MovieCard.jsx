...
function MovieCard({  id, title, poster, genres,  }) {
  return (
    <div id="movie-card" className="movie w-[300px]">
      ...
      <div className="desc mt-4">
        <div className="movie-title text-[24px] font-bold truncate w-5/6 indent-8" title={title}>{title}</div>
