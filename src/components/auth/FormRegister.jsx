...
export function FormRegister() {
  ...
  return (
    <div className="register">
      <section className="steps flex justify-between items-center mb-6">
          <div className="flex flex-col items-center gap-2.5"><img src={arrow1} alt="" /><p className="text-[14px]">Fill Form</p></div>
          <div className="h-px w-17.5 border border-dashed border-(--secondary-color)"></div>
          <div className="flex flex-col items-center gap-2.5"><img src={arrow2} alt="" /><p className="text-[14px] text-(--secondary-color)">Activate</p></div>
          <div className="h-px w-17.5 border border-dashed border-(--secondary-color)"></div>
          <div className="flex flex-col items-center gap-2.5"><img src={arrow3} alt="" /><p className="text-[14px] text-(--secondary-color)">Done</p></div>
        </section>
      <form className="flex flex-col" onSubmit={onSubmitHandler}>
        ...
        <input
          ...
          className="border-2 border-black px-2 h-16 rounded-[5px] mb-2"
          value={email}
        ...
        <div className="flex border-2 border-black w-full px-2 h-16 rounded-[5px] items-center justify-between relative">
          <input
          ...
          <img
            ...
            width={24}
            alt="show password"
            className="absolute right-6 cursor-pointer z-10"
        ...
        {errors.notChecked && (
          <p className="not-checked italic text-red-700 font-light">Required!</p>
        )}

        <button
          type="submit"
          className="w-full h-16 bg-(--primary-color) text-white border border-(--primary-color) rounded-[5px] mt-5 cursor-pointer"
        >
          Join for free
        </button>
      </form>
      <section className="my-2">
          <p>Already have an account? <Link className="text-blue-900 font-semibold underline">Log in</Link></p>
          <div className="flex justify-evenly items-center my-6.5">
            <div className="h-px w-40 border-b border-(--secondary-color)/50"></div>
            <p>or</p>
            <div className="h-px w-40 border-b border-(--secondary-color)/50"></div>
          </div>
          <div className="login-option flex gap-9">
            <div className="md:w-46 md:h-15.5 flex items-center md:justify-evenly border border-white rounded-[5px] shadow-[0_4px_10px_0_rgba(0,0,0,0.08)]">
              <img
                src={logoGoogle}
                alt="Logo Google"
              />
